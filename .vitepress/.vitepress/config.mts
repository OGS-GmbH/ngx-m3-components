...
export default defineConfig({
  ...
  description: "A collection of reusable, customizable UI components built with Angular and Material 3.",
  themeConfig: {
    ...
    nav: [
      ...
      { text: packageJson.version, items: [
        { text: "Repository", link: "https://github.com/OGS-GmbH/ngx-m3-components" },
        { text: "Changelog", link: "https://github.com/OGS-GmbH/ngx-m3-components/blob/main/CHANGELOG.md" },
  ...
  base: "/ngx-m3-components/",
  srcDir: "../dist/vitepress-src",
  outDir: "../dist/docs",
  titleTemplate: ":title - OGS ngx-m3-components",
  cleanUrls: true,
  appearance: true,
  markdown: {
